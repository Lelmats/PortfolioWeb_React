      ...
      <div className="">
        <a className="flex flex-col border-4 border-gray-400 rounded-lg md:flex-row items-center min-w-[40vw] md:max-w-[60vw] max-md:mx-8 mb-4 mx-4 
          ...
          <div className="flex flex-col justify-between p-4 leading-normal ">
            ...
            <p className="mb-3 text-base font-semibold md:text-md dark:text-gray-300 text-wrap">{description}</p>
            <div className="grid md:grid-flow-col grid-cols-3 w-fit md:flex ">
              {listTags}
              { linkGithub && (
              <button type="button" className="mr-1 py-1 px-2 text-xs max-w-fit h-fit flex  
              ...
              {itchLink && (
                <button type="button" className=" py-1 px-2 text-xs max-w-fit h-fit flex  
                     bg-gray-600 hover:bg-gray-700 focus:ring-gray-500 focus:ring-offset-gray-200 
                     text-white w-full transition ease-in duration-200 text-center font-semibold 
