    ...
    <div className="flex bg-backgroundPrimary items-center sm:pt-20 h-screen" style={backgroundStyle} id='Home'>
      <div className='font-JetBrains grid grid-cols-1 md:grid-cols-2 grid-flow-row w-screen mx-16 sm:mx-26 lg:mx-48 xl:mx-52'>
        ...
        <div className='flex justify-end'>
          ...
          <img className='object-contain max-sm:w-[20rem] h-[100%] sm:w-[20rem] md:w-[25rem] xl:w-[30rem] min-hover:scale-105 transition-transform duration-500' src="img\MaxCharacter.png" alt="" />
        </div>
      </div>
    </div>

    {/* Section 2 - About Me/Technologies */}
    <div className="flex bg-backgroundPrimary p-10 xl:p-28 items-center h-screen" style={backgroundStyle} id='AboutMe'>
