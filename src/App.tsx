    ...
    <div className="bg-cover flex bg-backgroundPrimary p-10 xl:p-28 items-center" style={backgroundStyle} id='AboutMe'>
      <div className='md:grid md:grid-flow-row'>
        ...
        <div className='md:grid md:grid-flow-col'>
          ...
          <div className=''>
              <img src="/img/Tech_Icons.png" alt="" className='mt-6 sm:mt-0 max-[600px]:h-[18rem] h-[22rem] sm:h-[25rem] xl:h-[30rem] object-contain mx-auto origin-center transition-all animate-spin-slow  '/>
          </div>
        </div>
      </div>
    </div>
